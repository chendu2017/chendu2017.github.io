...
I am currently a PhD student at Nanyang Business School, Nanyang Technological University, majoring in Operations Management (OM). It is my honor to be advised by Professor [Geoffrey A. Chua](https://dr.ntu.edu.sg//cris/rp/rp00989).--> My
...
commit and push an update to the repository, the
[GitHub pages](https://pages.github.com/) service creates static HTML
pages based on these files, which are hosted on GitHub's servers free of
charge.
...
process the structured data on the site, such as
...
[individual page](https://academicpages.github.io/talks/2012-03-01-talk-1)
...
the github.com interface. Navigate to a file (like
